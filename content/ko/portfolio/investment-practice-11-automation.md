...
weight: 110
aliases:
  - /portfolio/investing/stock/practice/part-11-automation/
---

## 자동매매 실행 (키움)

(자동화의 흐름 — 데이터→신호→주문→기록→모니터링 — 은 [투자 기초 ⑥](/ko/portfolio/investment-theory-06-derivatives-etf-mechanism/)에서 다뤘다. 여기서는 실행 수단만.)
