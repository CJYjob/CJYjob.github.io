...
[투자 이론](/series/investment-theory/)의 토대 위에서, 코스피200·코스닥150 정방향/인버스 ETF로 운용할 전략을 설계한다. 이 트랙은 "왜·무엇"(설계)이고, 실제 코드 구현·검증은 [투자 실습](/portfolio/investment-practice-09-implementation/)에서 다룬다. 지표·상품·수급의 *정의와 원리*는 모두 이론 트랙에 있고, 여기서는 그것을 *어떻게 활용할지*만 정한다.
